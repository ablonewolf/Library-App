...
public class ReviewController {
    ...
    public Page<Review> findReviewByBookId(@RequestParam Long bookId, @RequestParam(defaultValue = "1") Integer page,
                                           @RequestParam(defaultValue = "10") Integer size) {
        return reviewService.findReviewByBook(bookId, PageRequest.of(page - 1, size));
    }
}
