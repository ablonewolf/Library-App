...
export const BookCheckoutPage = () => {
  ...
  const [currentCheckoutBookCount, setCurrentCheckoutBookCount] = useState(0);
  const [
  ...
  useEffect(() => {
    fetchSingleBook(setBook, setIsLoadingBook, bookId).catch((error: any) => {
        ...
        <div className="row mt-5">
          <div className="col-md-2 col-sm-2">
            {book?.img ? (
              ...
              <img src={genericBookImg} width="226" height="349" alt="book" />
            )}
          </div>
          <div className="col-4 col-md-4 container">
            <div className="ml-2">
              ...
              <h3 className="d-inline-block text-black">Average Rating</h3>
