        ...
        <div className="row g-0">
          ...
          >
            <div className="ml-2 ">
              ...
              <p className="lead">
                Try to check as our collection is always changing. We work
                nonstop to provide most accurate and up-to-date book selection
                for our library members. We are diligent about our book choice
